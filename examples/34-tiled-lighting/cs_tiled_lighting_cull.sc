...
void main() {
    ...
    {   
        ...
        //
        //  e.g., suppose 3 threads and 8 visible lights:
        //  which thread each element is copied by: [0 1 2 0 1 2 0 1]
        //
        //  Because each thread copies a fixed, independent partition of the
        //  array, they can all copy in parallel without any coordination.
